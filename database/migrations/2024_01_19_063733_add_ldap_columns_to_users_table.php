...
class AddLdapColumnsToUsersTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('mgr_gtpusers', function (Blueprint $table) use ($driver) {
        ...
        if ($driver === 'sqlsrv') {
            DB::statement(
                $this->compileUniqueSqlServerIndexStatement('mgr_gtpusers', 'guid')
            );
        }
    }
    ...
    {
        Schema::table('mgr_gtpusers', function (Blueprint $table) {
